...
<% Passenger passenger = (Passenger)request.getAttribute("passengers"); %>
...
<table border="1" align="center">
	...
	<th>Edit</th>
		...
		<tr>
			...
			<td><a href="PassengerUpdate.jsp?id=<%=passenger.getPassengerid() %>">edit</a></td>
		</tr>
	
	
	</center>
</table>
<br><br><br><center><a href="PassengerLoginSuccess.html">Back to Passenger Home</a></center>
</body>
</html>